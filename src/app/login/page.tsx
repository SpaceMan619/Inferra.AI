...
export default function LoginPage() {
  ...
  return (
    <div className="auth-bg flex items-center justify-center px-4 py-12">
      ...
      <div
        className="absolute top-[15%] left-[10%] w-[300px] h-[300px] rounded-full pointer-events-none"
        style={{
      ...
      />
      <div
        className="absolute bottom-[20%] right-[15%] w-[250px] h-[250px] rounded-full pointer-events-none"
        style={{
      ...
      >
        ...
        {/* Card */}
        <div
          className="liquid-glass-dark rounded-2xl p-8"
        >
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button type="button" className="text-[11px] font-medium text-[var(--primary-light)] hover:text-white transition-colors cursor-pointer">
                  Forgot?
                </button>
              </div>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-3.5 py-2.5 rounded-xl text-[13px] text-white placeholder:text-white/20 outline-none transition-all duration-200 focus:ring-2 focus:ring-[var(--primary)]/30 pr-10"
                  style={{
                    background: "rgba(255,255,255,0.04)",
                    border: "1px solid rgba(255,255,255,0.08)",
                  }}
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-xl text-[13px] font-bold text-white transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 cursor-pointer mt-2"
              style={{
                background: "linear-gradient(145deg, #6058f7 0%, #4f46e5 55%, #3a33c0 100%)",
        ...
        <p className="text-center text-[12px] text-white/30 mt-6">
          ...
          <Link href="/signup" className="text-[var(--primary-light)] font-medium hover:text-white transition-colors">
            Create one
          </Link>
        </p>
      </motion.div>
