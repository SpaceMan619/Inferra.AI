...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      {/* Dark overlay — lets green glow bleed through */}
      <div
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <button type="button" className="text-[11px] text-white/60 hover:text-white/90 transition-colors cursor-pointer">
                      Forgot?
                    </button>
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-xl text-[13px] font-normal text-white transition-all duration-300 hover:-translate-y-0.5 cursor-pointer mt-1"
                  style={{
