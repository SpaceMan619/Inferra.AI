...
const COLOR_A = "#22c55e";   // brand green
const COLOR_B = "#818cf8";   // soft indigo
      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <h3 className="text-[18px] font-semibold tracking-[-0.03em] truncate"
              style={{ color: "#222f30" }}>
              {selected.country}
            </h3>
          </div>
        ...
        <div className="mt-3 flex items-center justify-between">
          <span className="text-[11px] font-light" style={{ color: "rgba(34,47,48,0.45)" }}>
              ...
              {filtered.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[12px] tabular-nums font-medium" style={{ color: isActive ? color : "rgba(34,47,48,0.35)" }}>
                      {c.readiness_score}
                    </span>
                  </button>
                );
  ...
  return (
    <div className="grid gap-2" style={{ gridTemplateColumns: "1fr 48px 1fr" }}>
      ...
      <div className="flex items-center gap-2 justify-end">
        <span className="text-[12px] tabular-nums font-medium" style={{ color: aWins ? colorA : "rgba(34,47,48,0.4)" }}>
          {scoreA}
        </span>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[12px] tabular-nums font-medium" style={{ color: bWins ? colorB : "rgba(34,47,48,0.4)" }}>
          {scoreB}
        </span>
      </div>
    </div>
    ...
    <div className="flex flex-col gap-6 max-w-[1100px] mx-auto">
      ...
      <div className="flex items-end gap-3">
        ...
        <button
          ...
          className="mb-0.5 flex-shrink-0 flex items-center justify-center rounded-xl transition-all duration-200 hover:scale-105"
          style={{
            width: 40, height: 40,
            backgroundColor: "#fff",
            border: "1px solid rgba(34,47,48,0.08)",
      ...
      <div className="flex gap-5 flex-col xl:flex-row">
        ...
        >
          ...
          {/* Founder insight snippets */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t" style={{ borderColor: "rgba(34,47,48,0.06)" }}>
            {([countryA, countryB] as const).map((c, i) => (
              <div key={c.country} className="p-3 rounded-xl" style={{ backgroundColor: "rgba(34,47,48,0.025)" }}>
          ...
          return (
            ...
            >
              ...
              <span
                ...
                style={{
                  color: winnerA ? COLOR_A : "#222f30",
                  fontWeight: winnerA ? 500 : 400,
                }}
              >
                {displayA}
              </span>
              <span
                className="font-normal"
                style={{
                  color: winnerB ? COLOR_B : "#222f30",
                  fontWeight: winnerB ? 500 : 400,
                }}
              >
                {displayB}
              </span>
